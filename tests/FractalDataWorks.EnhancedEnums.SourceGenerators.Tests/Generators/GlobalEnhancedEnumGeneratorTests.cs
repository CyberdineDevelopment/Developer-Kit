/* TEMPORARILY COMMENTED OUT - Waiting for new TestUtilities package
using System;
using System.Collections.Generic;
using System.Linq;
using FractalDataWorks.EnhancedEnums.CrossAssembly.Generators;
// using FractalDataWorks.SmartGenerators.TestUtilities; // TODO: Update to new package when available
...
public class GlobalEnhancedEnumGeneratorTests
{
    ...
    public void HandlesEmptyCollections()
    {
        ...
        ExpectationsFactory.ExpectCode(result)
            .HasClass("Colors", c => c
                .HasMethod("All", m => m.HasReturnType("ImmutableArray<ColorBase>"))
    ...
    public void HandlesCustomReturnTypes()
    {
        ...
        ExpectationsFactory.ExpectCode(result)
            .HasClass("Colors", c => c
                .HasMethod("All", m => m.HasReturnType("ImmutableArray<IColor>"))
