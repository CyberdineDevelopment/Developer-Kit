...
public sealed class AzureKeyVaultConfigurationValidator : AbstractValidator<AzureKeyVaultConfiguration>
{
    ...
    public AzureKeyVaultConfigurationValidator()
    {
        ...
        // Validate service principal authentication requirements
        ...
        // Validate certificate authentication requirements
        ...
        // Validate managed identity with specific ID
