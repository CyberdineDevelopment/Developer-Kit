...
/// </summary>
public sealed class EnumTypeInfo : FractalDataWorks.CodeBuilder.Abstractions.IInputInfo, IEquatable<EnumTypeInfo>
{
    ...
    /// <summary>
    /// Gets or sets a value indicating whether to use singleton instances for enum values.
    ...
    /// <summary>
    /// Gets or sets a value indicating whether the collection class inherits from EnumCollectionBase&lt;T&gt;.
