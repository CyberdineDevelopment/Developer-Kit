...
public static class EnumValueDiscoveryService
{
    ...
    /// </summary>
    public static IList<EnumValueInfo> DiscoverEnumValues(EnumTypeInfo def, INamedTypeSymbol baseTypeSymbol, Compilation compilation, SourceProductionContext context)
    {
        List<EnumValueInfo> values = new List<EnumValueInfo>();
