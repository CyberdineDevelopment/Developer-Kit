...
public static class EnumAttributeParser
{
    ...
    /// </summary>
    public static IList<EnumTypeInfo> ParseEnhancedEnumBase(INamedTypeSymbol symbol)
    {
        ...
        List<EnumTypeInfo> results = new List<EnumTypeInfo>();
    ...
    {
        List<PropertyLookupInfo> lookupProperties = new List<PropertyLookupInfo>();
    ...
    private static EnumTypeInfo CreateEnumTypeInfo(INamedTypeSymbol symbol, AttributeData attr, IList<PropertyLookupInfo> lookupProperties)
    {
        ...
        var collectionInfo = new EnumTypeInfo
        {
            ...
            UseSingletonInstances = named.TryGetValue("UseSingletonInstances", out var usi) && usi.Value is bool usib ? usib : true, // Default to true
