...
public sealed class ListSecretsCommand : SecretCommandBase, ISecretCommand<IReadOnlyList<ISecretMetadata>>
{
    ...
    /// </remarks>
    public string? Filter => Parameters.TryGetValue("Filter", out var filter) ? filter?.ToString() : null;

    /// <summary>
    /// Gets the maximum number of results to return.
    /// </summary>
    /// <value>The maximum number of secrets to return, or null for no limit.</value>
    public int? MaxResults => Parameters.TryGetValue("MaxResults", out var max) && 
    ...
    public bool IncludeDeleted => Parameters.TryGetValue("IncludeDeleted", out var include) && 
    ...
    public string? ContinuationToken => Parameters.TryGetValue("ContinuationToken", out var token) ? token?.ToString() : null;
    ...
    public bool IncludeVersions => Parameters.TryGetValue("IncludeVersions", out var include) && 
    ...
    public static ListSecretsCommand IncludingDeleted(string? container, bool includeVersions = false, TimeSpan? timeout = null)
    {
        ...
        if (includeVersions)
        {
            parameters["IncludeVersions"] = true;
        }
