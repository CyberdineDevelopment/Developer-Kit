...
public sealed class EnumCollectionAttribute : Attribute
{
    ...
    /// <summary>
    /// Gets or sets whether to use singleton instances for enum values.
    ...
    /// <param name="useSingletonInstances">Whether to use singleton instances for enum values.</param>
    public EnumCollectionAttribute(
